...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int accountId,  int categoryId, @DecimalConverter()  Decimal amount, @DateTimeConverter()  DateTime transactionDate,  String? comment)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransactionRequestModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int accountId,  int categoryId, @DecimalConverter()  Decimal amount, @DateTimeConverter()  DateTime transactionDate,  String? comment)  $default,) {final _that = this;
switch (_that) {
case _TransactionRequestModel():
return $default(_that.accountId,_that.categoryId,_that.amount,_that.transactionDate,_that.comment);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int accountId,  int categoryId, @DecimalConverter()  Decimal amount, @DateTimeConverter()  DateTime transactionDate,  String? comment)?  $default,) {final _that = this;
switch (_that) {
case _TransactionRequestModel() when $default != null:
return $default(_that.accountId,_that.categoryId,_that.amount,_that.transactionDate,_that.comment);case _:
  return null;
