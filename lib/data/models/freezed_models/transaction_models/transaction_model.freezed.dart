...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int accountId,  int categoryId, @DecimalConverter()  Decimal amount, @DateTimeConverter()  DateTime transactionDate,  String? comment, @DateTimeConverter()  DateTime createdAt, @DateTimeConverter()  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransactionModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int accountId,  int categoryId, @DecimalConverter()  Decimal amount, @DateTimeConverter()  DateTime transactionDate,  String? comment, @DateTimeConverter()  DateTime createdAt, @DateTimeConverter()  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _TransactionModel():
return $default(_that.id,_that.accountId,_that.categoryId,_that.amount,_that.transactionDate,_that.comment,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int accountId,  int categoryId, @DecimalConverter()  Decimal amount, @DateTimeConverter()  DateTime transactionDate,  String? comment, @DateTimeConverter()  DateTime createdAt, @DateTimeConverter()  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _TransactionModel() when $default != null:
return $default(_that.id,_that.accountId,_that.categoryId,_that.amount,_that.transactionDate,_that.comment,_that.createdAt,_that.updatedAt);case _:
  return null;
