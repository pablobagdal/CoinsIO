...
mixin _$StatItemModel {
 ...
 int get categoryId; String get categoryName; String get emoji;@DecimalConverter() Decimal get amount;
...
@useResult
$Res call({
 int categoryId, String categoryName, String emoji,@DecimalConverter() Decimal amount
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int categoryId,  String categoryName,  String emoji, @DecimalConverter()  Decimal amount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StatItemModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int categoryId,  String categoryName,  String emoji, @DecimalConverter()  Decimal amount)  $default,) {final _that = this;
switch (_that) {
case _StatItemModel():
return $default(_that.categoryId,_that.categoryName,_that.emoji,_that.amount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int categoryId,  String categoryName,  String emoji, @DecimalConverter()  Decimal amount)?  $default,) {final _that = this;
switch (_that) {
case _StatItemModel() when $default != null:
return $default(_that.categoryId,_that.categoryName,_that.emoji,_that.amount);case _:
  return null;
...
class _StatItemModel implements StatItemModel {
   _StatItemModel({required this.categoryId, required this.categoryName, required this.emoji, @DecimalConverter() required this.amount});
