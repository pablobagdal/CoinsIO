...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name, @DecimalConverter()  Decimal balance,  CurrencyEnum currency)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccountStateModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name, @DecimalConverter()  Decimal balance,  CurrencyEnum currency)  $default,) {final _that = this;
switch (_that) {
case _AccountStateModel():
return $default(_that.id,_that.name,_that.balance,_that.currency);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name, @DecimalConverter()  Decimal balance,  CurrencyEnum currency)?  $default,) {final _that = this;
switch (_that) {
case _AccountStateModel() when $default != null:
return $default(_that.id,_that.name,_that.balance,_that.currency);case _:
  return null;
...
class _AccountStateModel implements AccountStateModel {
  const _AccountStateModel({required this.id, required this.name, @DecimalConverter() required this.balance, required this.currency});
