...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int accountId,  String accountName,  CurrencyEnum currency, @DecimalConverter()  Decimal currentBalance,  List<AccountHistoryModel> history)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccountHistoryResponseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int accountId,  String accountName,  CurrencyEnum currency, @DecimalConverter()  Decimal currentBalance,  List<AccountHistoryModel> history)  $default,) {final _that = this;
switch (_that) {
case _AccountHistoryResponseModel():
return $default(_that.accountId,_that.accountName,_that.currency,_that.currentBalance,_that.history);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int accountId,  String accountName,  CurrencyEnum currency, @DecimalConverter()  Decimal currentBalance,  List<AccountHistoryModel> history)?  $default,) {final _that = this;
switch (_that) {
case _AccountHistoryResponseModel() when $default != null:
return $default(_that.accountId,_that.accountName,_that.currency,_that.currentBalance,_that.history);case _:
  return null;
...
class _AccountHistoryResponseModel implements AccountHistoryResponseModel {
  const _AccountHistoryResponseModel({required this.accountId, required this.accountName, required this.currency, @DecimalConverter() required this.currentBalance, required final  List<AccountHistoryModel> history}): _history = history;
