...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name, @DecimalConverter()  Decimal balance,  CurrencyEnum currency,  List<StatItemModel> incomeStats,  List<StatItemModel> expenseStats, @DateTimeConverter()  DateTime createdAt, @DateTimeConverter()  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccountResponseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name, @DecimalConverter()  Decimal balance,  CurrencyEnum currency,  List<StatItemModel> incomeStats,  List<StatItemModel> expenseStats, @DateTimeConverter()  DateTime createdAt, @DateTimeConverter()  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _AccountResponseModel():
return $default(_that.id,_that.name,_that.balance,_that.currency,_that.incomeStats,_that.expenseStats,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name, @DecimalConverter()  Decimal balance,  CurrencyEnum currency,  List<StatItemModel> incomeStats,  List<StatItemModel> expenseStats, @DateTimeConverter()  DateTime createdAt, @DateTimeConverter()  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _AccountResponseModel() when $default != null:
return $default(_that.id,_that.name,_that.balance,_that.currency,_that.incomeStats,_that.expenseStats,_that.createdAt,_that.updatedAt);case _:
  return null;
