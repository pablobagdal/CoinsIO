...
mixin _$AccountHistoryModel {
 ...
 int get id; int get accountId; AccountHistoryChangeType get changeType; AccountStateModel? get previousState; AccountStateModel get newState; String get changeTimestamp;@DateTimeConverter() DateTime get createdAt;
...
@useResult
$Res call({
 int id, int accountId, AccountHistoryChangeType changeType, AccountStateModel? previousState, AccountStateModel newState, String changeTimestamp,@DateTimeConverter() DateTime createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int accountId,  AccountHistoryChangeType changeType,  AccountStateModel? previousState,  AccountStateModel newState,  String changeTimestamp, @DateTimeConverter()  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccountHistoryModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int accountId,  AccountHistoryChangeType changeType,  AccountStateModel? previousState,  AccountStateModel newState,  String changeTimestamp, @DateTimeConverter()  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _AccountHistoryModel():
return $default(_that.id,_that.accountId,_that.changeType,_that.previousState,_that.newState,_that.changeTimestamp,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int accountId,  AccountHistoryChangeType changeType,  AccountStateModel? previousState,  AccountStateModel newState,  String changeTimestamp, @DateTimeConverter()  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _AccountHistoryModel() when $default != null:
return $default(_that.id,_that.accountId,_that.changeType,_that.previousState,_that.newState,_that.changeTimestamp,_that.createdAt);case _:
  return null;
...
class _AccountHistoryModel implements AccountHistoryModel {
  const _AccountHistoryModel({required this.id, required this.accountId, required this.changeType, this.previousState, required this.newState, required this.changeTimestamp, @DateTimeConverter() required this.createdAt});
