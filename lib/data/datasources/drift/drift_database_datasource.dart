...
import 'package:coinio_app/data/models/drift_models/account_table.dart';
import 'package:coinio_app/data/models/drift_models/backup_operation_table.dart';
import 'package:coinio_app/data/models/drift_models/category_table.dart';
import 'package:coinio_app/data/models/drift_models/transaction_table.dart';
...
class DriftDatabaseDatasource extends _$DriftDatabaseDatasource {
  ...
  Future<BackupOperationTableData> createOrUpdateBackupOperation(
    ...
    return (select(backupOperationTable)
